...
{
    public class ScheduleEvent : AbstractEvaluationRequest
    {
        public ScheduleEvent(long time, string action, dynamic[] parameters = null,
            string module = "NONE", int priority = 0, bool maintenance = false, string destination = null,
            string details = null, bool output = true,
            bool timeInMs = false, string precondition = null, string model = null) : base("schedule-event", model)
        {
            Time = time;
            Action = action;
