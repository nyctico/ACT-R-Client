...
{
    public class ScheduleEventNow : AbstractEvaluationRequest
    {
        public ScheduleEventNow(string action, dynamic[] parameters = null,
            string module = "NONE", int priority = 0, bool maintenance = false, string destination = null,
            string details = null, bool output = true,
            string precondition = null, string model = null) : base("schedule-event-now", model)
        {
            Action = action;
